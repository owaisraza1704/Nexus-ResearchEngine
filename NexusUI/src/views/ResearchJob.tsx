  ...
  return (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        <button onClick={() => router.push(`/research/${research.id}/runs`)} style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#55535d', display: 'flex', gap: 4, alignItems: 'center' }}>
          <ChevronLeft size={14} />
